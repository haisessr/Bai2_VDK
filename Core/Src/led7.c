...
void LED7_WriteByte1(uint8_t a)
{
 if (((a >> 0) & 0x01) == 1) { A1_SET(); } else { A1_RESET(); }
 if (((a >> 1) & 0x01) == 1) { B1_SET(); } else { B1_RESET(); }
 if (((a >> 2) & 0x01) == 1) { C1_SET(); } else { C1_RESET(); }
 if (((a >> 3) & 0x01) == 1) { D1_SET(); } else { D1_RESET(); }
 if (((a >> 4) & 0x01) == 1) { E1_SET(); } else { E1_RESET(); }
 if (((a >> 5) & 0x01) == 1) { F1_SET(); } else { F1_RESET(); }
 if (((a >> 6) & 0x01) == 1) { G1_SET(); } else { G1_RESET(); }
 if (((a >> 7) & 0x01) == 1) { DP1_SET(); } else { DP1_RESET(); }
}
